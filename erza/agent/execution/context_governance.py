...
from erza.agent.execution.recovery import _SNIP_SAFETY_BUFFER
...
class ContextGovernanceService:
    ...
    async def govern_messages(
        ...
        """
        try:
            from erza.agent.context_governor import GovernanceContext
    ...
    def compute_prompt_components(self, spec: AgentRunSpec, messages: list[dict[str, Any]]) -> Any:
        ...
        from erza.agent.turn_telemetry import PromptComponentTokens
    ...
    def compute_pressure(
        ...
        from erza.agent.context_governor import PressureLevel, PressureSignal
